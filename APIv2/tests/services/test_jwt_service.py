...
class TestJWTService:
    ...
    def test_create_token_pair_returns_valid_tokens(self, jwt_service, user_data):
    ...
    def test_token_rotation_generates_different_tokens(self, jwt_service, user_data):
    ...
    def test_verify_valid_token(self, jwt_service, user_data):
    ...
    def test_verify_expired_token(self, jwt_service, user_data):
    ...
    def test_refresh_token_hash_consistency(self, jwt_service):
