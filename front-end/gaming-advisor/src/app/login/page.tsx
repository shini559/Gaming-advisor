...
export default function LoginPage() {
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    try {
      ...
      // On récupère les infos de l'utilisateur et on stocke son ID
      const { response: userResponse } = await fetchWithAuth('https://gameadvisor-api-containerapp.purpleplant-bc5dabd4.francecentral.azurecontainerapps.io/auth/me');
